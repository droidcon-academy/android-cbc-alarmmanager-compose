...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var scheduledAlarm: ScheduledAlarmItem? = null
        ...
        setContent {
            AlarmManagerTheme(dynamicColor = false) {
                ...
                Column(
                    ...
                    AlarmButtons(
                        onClickSchedule = {
                            val alarmTime = state.toLocalDateTime()

                            scheduledAlarm = ScheduledAlarmItem(alarmTime, messageText)
                            scheduledAlarm?.let(alarmHelper::schedule)
                            messageText = ""
                        },
                        onClickCancel = { scheduledAlarm?.let(alarmHelper::cancel) }
                    )
                }
            }
        }
